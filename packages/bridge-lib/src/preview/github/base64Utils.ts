...
export function b64ToUint6(nChr: any) {
...
export function uint6ToB64(nUint6: any) {
    return nUint6 < 26
        ? nUint6 + 65
        : nUint6 < 52
            ? nUint6 + 71
...
export function base64EncArr(aBytes: any) {
    let nMod3 = 2;
    let sB64Enc = "";
...
export function strToUTF8Arr(sDOMStr: any): Uint8Array {
    let aBytes;
    let nChr;
